...
fun getInstructionsClusteredHistogram(paint : Paint) : MutableList<Instruction>{
    ...
    printMarksSimpleVersion(instructions, x0, y0 + 300f, 20f, proportion, paint)
